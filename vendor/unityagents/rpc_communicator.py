...
class UnityToExternalServicerImplementation(UnityToExternalServicer):
    # PATCH (2026): in ml-agents v0.4 these were CLASS attributes, so every
    # UnityEnvironment in a process shared one Pipe and concurrent envs
    # cross-talked. Per-instance pipes make parallel envs safe.
    def __init__(self):
